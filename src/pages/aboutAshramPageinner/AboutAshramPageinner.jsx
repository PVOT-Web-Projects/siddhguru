...
import HeadingContentAshram from "../../components/headingContentAshram/HeadingContentAshram";
import HeadingContentAshramInner from "../../components/headingContentAshramInner/headingContentAshramInner";
  ...
  return (
    <div className="aboutAshramPage">
      ...
      <InnerPageCommonText
        ...
        hindiText3={
          <>
            श्री ब्रह्मर्षि आश्रम में स्थापित प्राण वृद्धि सिस्टम को यूनिफाइड हीलिंग (
            <a
              href="https://www.unifydhealing.com"
              target="_blank"
              rel="noopener noreferrer"
            ...
            ) द्वारा गुरुदेव के जनसेवा के कार्यक्रमों में सहभागी होने के हेतु से अर्पण किया गया है।
      ...
      <HeadingContentAshram
        ...
        extracontentHindi1={"एनर्जी एनहैन्समेन्ट सिस्टम™ की तकनिकी के बारे में विस्तृत लेकिन आसान भाषा में जानकारी प्राप्त करने के लिए इस विडिओ को पूरा देखें: "}
      ...
      <HeadingContentAshramInner
        ...
        hindiContent={"यह शारीरिक एवं पर्यावरण की दॄष्टि से एक सुरक्षित सिस्टम है जो पौराणिक स्वास्थ्य सिद्धांतो और आधुनिक तकनिकी पर आधारित है। श्री ब्रह्मर्षि आश्रम में प्राण वृद्धि EE सिस्टम का उपयोग करना पूर्णतया निः शुल्क है।"}
        extracontent={
        ...
        hindiHeading1={
          <>
            प्राण वृद्धि (एनर्जी एनहैन्समेन्ट सिस्टम™) के अद्भुत स्वास्थ्यवर्धक अनुभवों के बारे में अधिक जानकारी के लिए  (
            <a
              href="https://eesystem.com/"
              target="_blank"
              rel="noopener noreferrer"
        ...
        heading2={
          <>
            ...
            at
            <a href="tel:+919845823095" className="telephone_no"> +919845823095</a>
          </>
        }
        hindiContent2={
          <>
          निवास की सुविधा से सम्बंधित जानकारी के लिए श्री ब्रह्मर्षि आश्रम का संपर्क करें: 
          <a href="tel:+919845823095" className="telephone_no"> +919845823095</a>
        </>
        }
